...
#' @seealso \code{\link[MetaG]{MetaG.summary}}, \code{\link[MetaG]{study_info}}, \code{\link[MetaG]{reference_data}}, \code{\link[MetaG]{MetaG.plot}}.
#' @examples
...
#' result_diff <- MetaG(study_info, reference_data, model, variable_intercepts = TRUE)
#' print(result_diff)
#' # When the true intercept parameters of the studies are same.
#' result_same <- MetaG(study_info, reference_data, model)
#' print(result_same)
