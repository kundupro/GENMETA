#Ideal setting but the reference data is not standardized(mean is not 0 but variance is 1)
...
write.csv(result, file = "Simulation_12.csv", row.names = F)
