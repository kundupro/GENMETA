#Equal means but different variances across studies with correlation being the same, ref data from study 1
...
write.csv(result, file = "Simulation_3.csv", row.names = F)
