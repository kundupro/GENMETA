#Different means and equal variances across studies, equal correlations across studies but ref is one of them(first study mean and second study covariance)
