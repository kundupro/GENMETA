#No Inclusion Criterion on reference dataset
...
write.csv(Reduce("+", corr.data.m1) / length(corr.data.m1), file = "Simulation_15_study_1_corr.csv")
write.csv(Reduce("+", corr.data.m2) / length(corr.data.m2), file = "Simulation_15_study_2_corr.csv")
write.csv(Reduce("+", corr.data.m3) / length(corr.data.m3), file = "Simulation_15_study_3_corr.csv")
