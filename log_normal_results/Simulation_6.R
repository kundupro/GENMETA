#Equal means and variances across studies, different correlations across studies but ref is one of them(first study)
...
write.csv(result, file = "Simulation_6.csv", row.names = F)
